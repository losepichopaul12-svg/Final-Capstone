     ...
     <h5>Quick Links</h5>
      <ul className="nav  mb-3 flex-column">
          <li className="nav-item">
            <Link className="nav-link text-white fw-bolder " to="/Home"><i className="fa-solid fa-house"></i>HOME</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link text-white fw-bolder " to="/Jobs"><i className="fa-solid fa-briefcase m-2"></i>JOBS</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link text-white fw-bolder " to="/Login"><i class="fa-solid fa-right-to-bracket m-2"></i>LOGIN</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link text-white fw-bolder " to="/Register"><i class="bi bi-person-vcard m-2"></i>REGISTER</Link>
          </li>
        </ul>
     </div>
